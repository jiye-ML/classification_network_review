...
tf.app.flags.DEFINE_string(
    'eval_dir', 'result/', 'Directory where the results are saved to.')
...
tf.app.flags.DEFINE_integer('eval_interval_secs', None, 'The minimum number of seconds between evaluations')
